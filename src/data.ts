...
export const markets: Market[] = [
  { symbol: "$FROG", price: "0.0042", change1h: 12.4, change24h: 86.7, volume: "12.4M", buyPressure: 78, signal: 91, trend: "UP" },
  { symbol: "$PEPE", price: "0.0018", change1h: 8.1, change24h: 32.6, volume: "8.7M", buyPressure: 71, signal: 83, trend: "UP" },
  { symbol: "$WIF", price: "0.415", change1h: 3.9, change24h: 24.1, volume: "14.2M", buyPressure: 66, signal: 76, trend: "UP" },
  { symbol: "$MOG", price: "0.0061", change1h: -2.4, change24h: 19.3, volume: "6.1M", buyPressure: 44, signal: 54, trend: "DOWN" },
  { symbol: "$POPCAT", price: "0.312", change1h: 4.9, change24h: 24.1, volume: "7.8M", buyPressure: 69, signal: 74, trend: "UP" },
  { symbol: "$NEIRO", price: "0.0281", change1h: 9.2, change24h: 41.7, volume: "5.4M", buyPressure: 82, signal: 88, trend: "UP" },
  { symbol: "$BONK", price: "0.0021", change1h: 3.1, change24h: 18.2, volume: "4.9M", buyPressure: 61, signal: 67, trend: "UP" },
  { symbol: "$DOGE", price: "0.182", change1h: 1.7, change24h: 12.8, volume: "28.1M", buyPressure: 58, signal: 62, trend: "FLAT" }
];
